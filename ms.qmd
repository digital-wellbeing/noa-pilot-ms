...
**Affect** was measured with a single item: "How are you feeling right now?" [@KillingsworthGilbert2010Wandering]. Participants responded using a 100-point visual analogue scale (VAS) with endpoints "Very bad" and "Very good", which we rescaled to 1-5 to match the other well-being measures.
